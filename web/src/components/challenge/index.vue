<template>
  <transition v-if="visible" name="aiagain-Challenge">
    <div class="aiagain-Challenge">
      <div class="aiagain-Challenge-wrap bounceIn">
        <div class="aiagain-Challenge-head">
          ...
          <div v-if="data.type==1" class="aiagain-Challenge-head-bgShine bgShine-rotate"></div>
        </div>
        <div class="aiagain-Challenge-main">
          <p v-for="(x,k) in data.list" class="aiagain-Challenge-text">{{ x }}</p>
        </div>
